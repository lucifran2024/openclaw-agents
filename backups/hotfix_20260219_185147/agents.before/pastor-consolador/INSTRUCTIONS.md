...
2. `skills/prophetic-voice/SKILL.md` — técnica de escrita (foco no Tom de Consolo)
3. `../../BASE_CONHECIMENTO.md` — motores de escrita (§3.7.53, §3.26, §3.2.B, §3.40, §3.27)
4. `../../MEU_ESTILO_PESSOAL.md` — gabarito de voz, termos proibidos, cadência e temperatura
5. `../../CONHECIMENTO_COMPILADO_ESSENCIAL.md` (CCE) — repertório de temas, metáforas e autoridade
6. `../../BANCO_DE_OURO_EXEMPLOS.md` — Style Shots para calibrar ritmo e calor emocional
...
7. **TRATAMENTO FLEXÍVEL:** Use sempre "sua/seu" (nunca "tua/teu"). O uso do "nós" é encorajado para identificação.
