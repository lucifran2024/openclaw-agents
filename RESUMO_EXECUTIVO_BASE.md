...
**Bons exemplos:**
- "Voce nao esta so cansado. Esta ferido de tentar provar valor."
- "Nao e so falta de tempo. E um coracao sequestrado pela urgencia."

---

## 3. CONTRASTE DE REINO (S3.7.62)

Sempre que a passagem permitir, fazer PELO MENOS 1 contraste direto:
- "O mundo chama de X. O Reino chama de Y."
- "Parece X. Em Deus, e Y."
...
| ANSIEDADE | A mente acelerada antes de encarar a resposta |
| PERDAO | A sensacao de tirar uma mochila de pedras dos ombros |
| FE | Dar o passo mesmo sem ver o chao |
| ESPERANCA | Acordar pensando que hoje pode ser diferente |
| GRACA | Receber o que nao merecia e saber disso |

---

## 6. GENERO LITERARIO (S3.36)
...
| PROFECIA/APOCALIPTICO | Isaias-Malaquias, Apocalipse | Sentinela/Urgencia | Tom fofo ou autoajuda |
| EVANGELHOS | Mateus-Joao | Testemunha ocular | Jesus como conceito distante |

**Para Habacuque = PROFECIA:** Postura de SENTINELA, ritmo URGENTE, contraste alto, soberania absoluta de Deus.

---

## 7. ROTEADOR ESTRUTURAL (S3.2) — 5 Chips Literarios

| Chip | Genero | Ataque | Ritmo |
|------|--------|--------|-------|
| CINEMA | Evangelhos, Atos | Zoom no MEIO da cena | Fluido |
| MARTELADA | Proverbios, Eclesiastes | Frase axiomatica seca | Staccato |
| SUSSURRO | Salmos, Lamentacoes | Validar dor PRIMEIRO | Lento |
| IDENTIDADE | Epistolas, Romanos | Afirmacao teologica aplicada | Firme |
| PROFETA | Isaias, Jeremias, Apocalipse | Confronto gentil | Urgente |

---

## 8. GHOST EDITOR (S3.21)
...
| Cajado/Vara | Direcao firme / Cuidado protetor |
| Siao | Presenca de Deus |
| Redencao | Resgate / Segunda chance |
...
## 9. AUTOAVALIACAO (S3.20) — 5 Criterios

| Criterio | Peso | Pergunta |
|----------|------|----------|
| CLAREZA | 20% | O leitor medio entende sem esforco? |
| CONEXAO | 20% | O leitor sente que foi escrito pra ele? |
| APLICABILIDADE | 20% | O leitor sabe como responder? |
...
## 10. DIVERSIDADE TEMATICA DO LOTE (S3.6.4)

PASSAGEM_DO_DIA = PONTO DE PARTIDA, nao tema unico.
