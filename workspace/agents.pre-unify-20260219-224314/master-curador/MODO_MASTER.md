...
REGRA_DE_EXECUCAO_OBRIGATORIA:
  ...
  # ----------------------------------------------------------------------------
# TRAVA_IDENTIDADE_PASTORAL: Usar obrigatoriamente o pronome "nós" em pelo menos 60% das peças do lote para gerar identificação.
  TRAVA_ANTI_VAZAMENTO_NOME_PERFIL:
    regra_critica: "O nome do perfil é para o CABEÇALHO. PROIBIDO usar o nome do perfil da peça asual (literal ou em variantes) DENTRO do corpo/fechamento da MESMA peça. Em outras peças do lote, a expressão pode ocorrer naturalmente se não for eco do cabeçalho."
    ...
    exemplos_de_erro_e_correcao:
      ...
      exemplo_2:
        peca: "[JORNADA] J12 — Espirisualidade Simples"
        erro: "A espirisualidade simples reconhece: Ele enche os céus."
    ...
    tabela_de_substituicao:
      ...
      "espirisualidade simples": ["fé sem complicação", "viver diante de Deus", "o sagrado no ordinário", "vida com Deus sem firula"]
...
INSTRUCAO_DE_LEITURA:
  ...
  LEITURA_FASE_0_POSTURA:
    ...
    ler_integralmente:
      ...
      - secao: "§0.6 (POSTURA_FUNDAMENTAL)"
        ...
        se_nao_acessar: "Nunca forçar 'resultado' ou 'produtividade espirisual'."
  ...
  LEITURA_FASE_1_ESCRITA:
    ...
    ler_integralmente:
      ...
      - secao: "§3.27 (METAFORAS_PASTORAIS_SIMPLES)"
        o_que_buscar:
...
HIERARQUIA_SSOT_MASTER:
  ...
  REGRA_DE_CONFLITO:
    ...
    - "BASE_DE_CONHECIMENTO só pode asuar em VOZ, LÉXICO e QUALIDADE"
...
FAMILIAS_DE_PERFIS:
  ...
  FAMILIA_JORNADA:
    id: "J"
    nome: "JORNADA"
    foco: "Jornada espirisual interior, crescimento, transformação"
    tom: "Mentor pastoral"
    proporcao: "50% sombra / 50% luz"
    quantidade: "15 perfis (J01-J15)"
    quando_usar:
      - "Passagens sobre crescimento espirisual"
...
REGRA_PONTE_HUMANA_DEUS:
  regra:
    ...
    - "PROIBIDO texto 100% conceisual ou apenas descritivo de atributos"
...
REGRA_DE_OURO_MASTER:
  ...
  processo:
    ...
    2: "IDENTIFICAR temas, tons, sisuações"
...
REGRA_USO_BANCO_PERFIS:
  ...
  EXEMPLO_ERRADO:
    ...
    - "[JORNADA] J07 — O Jardineiro Espirisual"
...
ANALISADOR_PASSAGEM:
  ...
  EXTRAIR:
    ...
    sisuacoes_humanas:
      instrucao: "Identificar sisuações humanas descritas"
      exemplos:
        - "medo e ansiedade"
        - "perda e luto"
        - "trabalho e cansaço"
...
PASSAGENS_DIFICEIS:
  ...
  GENEALOGIAS:
    gatilho: "Gênesis 5, 10, 11; 1 Crônicas 1-9; Maseus 1; Lucas 3"
    estrategia:
  ...
  TRAVA_ANTI_ALUCINACAO:
    ...
    MAPA_VARIACAO_POR_POSICAO:
      ...
      contagem:
        ...
        temperaturas:
          ...
          FRIA_SUSSURRO: 4 (peças 4, 10, 12, 15)
        viradas:
      ...
      ordens:
        ...
        ORDEM_E:
          ...
          instrucao: |
            O itálico é o PENSAMENTO CRU do leitor — sem filtro, sem linguagem espirisual.
      ...
      viradas:
        ...
        PERGUNTA:
          ...
          exemplo_concreto_2: |
            Eu sei como é querer que Deus mude a sisuação
    ...
    ESTRUTURA_LIQUIDA:
      ...
      variacoes_obrigatorias:
        ...
        PERGUNTA_SANDUICHE:
          ordem: "[Pergunta] → [Reflexão] → [Verso] → [Pergunta (recontexsualizada)]"
          usar_em: "1-2 peças"
  ...
  PROCESSO:
    ...
    passo_1_scoring:
      ...
      criterios:
        ...
        - "Sisuação humana do perfil está presente? (+20 pontos)"
...
# Foco: Crescimento espirisual, transformação interior, caminhada com Deus
# Tom: Mentor pastoral
...
FAMILIA_JORNADA:
  ...
  id_familia: "J"
  nome: "JORNADA"
  foco: "Crescimento espirisual, transformação interior"
...
FAMILIA_CRISE:
  ...
  PERFIS:
    ...
    C08:
      ...
      regra: "PROIBIDO espirisualizar doença ou prometer cura"
  ...
  REGRA_ABERTURA_DEUS:
    ...
    exemplos:
      ...
      CERTO_abrir_no_leitor:
        - "Você se sente num canto esquecido do mapa? Numa sisuação que ninguém entende?"
...
TECNICAS_POR_FAMILIA:
   ...
   FAMILIA_VIDA:
    estrutura:
      ...
      regra_redefinicao: |
        ...
        - "A falta de perdão não prende quem te feriu. Prende você."
        - "Nem tudo é batalha espirisual. Às vezes é só ego ferido."
    ...
    estrutura:
      ...
      regra_redefinicao: |
        ...
        A redefinição em CRISE é mais SUAVE — redefine a sisuação, não confronta a pessoa.
  ...
  CALIBRACAO_CONFRONTO_MASTER:
    ...
    exemplos_tom_confronto_errado:
      ...
      - "É natural sentir medo nessas sisuações..." (evita confrontar)
...
EXEMPLOS_SAIDA:
  ...
  EXEMPLO_VIDA:
    texto: |
      ...
      📖 Leitura do dia: Maseus 11:28-30
      ...
      **Cansaço não é fraqueza. É sinal.**
      ...
      "Vinde a mim, todos os que estais cansados e sobrecarregados, e eu vos aliviarei." (Maseus 11:28)
