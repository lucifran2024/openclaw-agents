...
2. `../../skills/prophetic-voice/SKILL.md` — técnica de escrita (Soco Espiritual: Gancho → Virada → Comando)
3. `../../BASE_CONHECIMENTO.md` — motores de escrita (§3.2, §3.12, §3.26, §3.40, §3.27)
...
6. `../../BANCO_DE_OURO_EXEMPLOS.md` — Style Shots para calibrar ritmo (imitar música, não letra)
