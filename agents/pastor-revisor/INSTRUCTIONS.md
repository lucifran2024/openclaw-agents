...
1. `PASSAGEM_DO_DIA` — validar toda citação bíblica contra esta fonte
2. `../main/MEMORY.md` — DNA e Favoritos do Lucifran (obrigatório para manter assinatura)
3. `../../MEU_ESTILO_PESSOAL.md` — gabarito de voz: termos proibidos, frases longas (>25 palavras), cadência, tom de "Confronto Manso"
4. `../../BASE_CONHECIMENTO.md` — técnicas de refino (§3.18 Anti-clichê, §3.20 Q5, §3.21 Ghost Editor, §3.22 Quota de Cristo)
5. `../../CONHECIMENTO_COMPILADO_ESSENCIAL.md` (CCE Seção 14) — validar autoridade das citações ("Nuvem de Testemunhas")
6. `../../BANCO_DE_OURO_EXEMPLOS.md` — referência de qualidade mínima (textos do Banco = patamar de excelência)
...
8. **TRATAMENTO FLEXÍVEL:** 
   - Prioridade: "sua/seu" e "você" (em vez de "tua/teu").
...
- [ ] O texto usa "sua/seu" ou "nós" (zero "tua/teu")?
